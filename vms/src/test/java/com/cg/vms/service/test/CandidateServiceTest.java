...
class CandidateServiceTest {
	...
	void testCreateCandidate() throws Exception{
		...
		candidate.setFirstName("Charushi");
		candidate.setLastName("Turkar");
	...
	void testGetAllCandidates() throws Exception{
		...
		viewcandidate.setFirstName("Digvijay");
		viewcandidate.setLastName("Ravi");
		...
		Candidate viewcandidate1 = new Candidate();
	   	...
	   	viewcandidate1.setFirstName("Mahi");
	   	viewcandidate1.setLastName("naidu");
	...
	void testdeleteCandidate() throws Exception{
		...
		candidate1.setCandidateId(003L);
	   	candidate1.setFirstName("Arnav");
	   	candidate1.setLastName("Arnav");
